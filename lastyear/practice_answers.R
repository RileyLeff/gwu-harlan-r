...
# On mac
setwd("/Users/Ezra Kottler/Documents/data")
...
#When you've reached this point, save the script then put put a star emoji in the chat and wait until everyone is done
